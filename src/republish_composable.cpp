...
#include "event_camera_legacy_tools/republish_ros2.h"

namespace event_camera_legacy_tools
{
...
private:
  std::shared_ptr<event_camera_legacy_tools::Republish<dvs_msgs::msg::EventArray>> nodeDvs_;
  std::shared_ptr<event_camera_legacy_tools::Republish<prophesee_event_msgs::msg::EventArray>>
    nodeProphesee_;
  std::shared_ptr<event_camera_legacy_tools::Republish<event_camera_msgs::msg::EventPacket>>
    nodeEventPacket_;
};
...
RCLCPP_COMPONENTS_REGISTER_NODE(event_camera_legacy_tools::RepublishComposable)
